...
1. Запускаем контейнер с базой данных `docker-compose up -d`
2. Запускаем локальный сервер `php -S 127.0.0.1:8000` 
3. Открываем браузер и переходим по ссылке: `http://127.0.0.1:8000/`
